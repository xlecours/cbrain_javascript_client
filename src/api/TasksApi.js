...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CbrainTask'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CbrainTask'));
  } else {
    // Browser globals (root is window)
    if (!root.CbrainApi) {
      root.CbrainApi = {};
    }
    root.CbrainApi.TasksApi = factory(root.CbrainApi.ApiClient, root.CbrainApi.CbrainTask);
  }
}(this, function(ApiClient, CbrainTask) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CbrainTask} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/CbrainTask}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CbrainTask} opts.cbrainTask The task to create.
     * @param {module:api/TasksApi~tasksPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CbrainTask>}
     */
    this.tasksPost = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['cbrainTask'];
