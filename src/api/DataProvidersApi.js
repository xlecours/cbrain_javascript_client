...
(function(root, factory) {
  if (typeof define === 'function' && false) {
    ...
    define(['ApiClient', 'model/DataProvider'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DataProvider'));
  } else {
    // Browser globals (root is window)
    if (!root.CbrainApi) {
      root.CbrainApi = {};
    }
    root.CbrainApi.DataProvidersApi = factory(root.CbrainApi.ApiClient, root.CbrainApi.DataProvider);
  }
}(this, function(ApiClient, DataProvider) {
  'use strict';
