...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Bourreau', 'model/CbrainTask', 'model/DataProvider', 'model/FileInfo', 'model/Group', 'model/InlineResponse200', 'model/InlineResponse2001', 'model/InlineResponse2002', 'model/Tag', 'model/Tool', 'model/ToolConfig', 'model/User', 'model/User1', 'model/Userfile', 'api/BourreauApi', 'api/DataProvidersApi', 'api/GroupsApi', 'api/SessionsApi', 'api/TagsApi', 'api/TasksApi', 'api/ToolConfigsApi', 'api/ToolsApi', 'api/UserfilesApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Bourreau'), require('./model/CbrainTask'), require('./model/DataProvider'), require('./model/FileInfo'), require('./model/Group'), require('./model/InlineResponse200'), require('./model/InlineResponse2001'), require('./model/InlineResponse2002'), require('./model/Tag'), require('./model/Tool'), require('./model/ToolConfig'), require('./model/User'), require('./model/User1'), require('./model/Userfile'), require('./api/BourreauApi'), require('./api/DataProvidersApi'), require('./api/GroupsApi'), require('./api/SessionsApi'), require('./api/TagsApi'), require('./api/TasksApi'), require('./api/ToolConfigsApi'), require('./api/ToolsApi'), require('./api/UserfilesApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, Bourreau, CbrainTask, DataProvider, FileInfo, Group, InlineResponse200, InlineResponse2001, InlineResponse2002, Tag, Tool, ToolConfig, User, User1, Userfile, BourreauApi, DataProvidersApi, GroupsApi, SessionsApi, TagsApi, TasksApi, ToolConfigsApi, ToolsApi, UserfilesApi, UsersApi) {
  'use strict';

  /**
   * REST_API_for_interacting_with_the_CBRAIN_Platform.<br>
