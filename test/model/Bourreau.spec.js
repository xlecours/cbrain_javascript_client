...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CbrainApi.Bourreau();
  });
  ...
  describe('Bourreau', function() {
    it('should create an instance of Bourreau', function() {
      // uncomment below and update the code to test Bourreau
      //var instane = new CbrainApi.Bourreau();
      //expect(instance).to.be.a(CbrainApi.Bourreau);
    });
