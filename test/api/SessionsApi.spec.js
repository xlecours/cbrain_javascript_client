...
(function(root, factory) {
  ...
  describe('SessionsApi', function() {
    ...
    describe('sessionNewGet', function() {
      it('should call sessionNewGet successfully', function(done) {
        //uncomment below and update the code to test sessionNewGet
        //instance.sessionNewGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
