...
*CbrainApi.SessionsApi* | [**sessionDelete**](docs/SessionsApi.md#sessionDelete) | **DELETE** /session | Destroy the session
*CbrainApi.SessionsApi* | [**sessionGet**](docs/SessionsApi.md#sessionGet) | **GET** /session | Get session information
*CbrainApi.SessionsApi* | [**sessionNewGet**](docs/SessionsApi.md#sessionNewGet) | **GET** /session/new | New session initiator
...
## Documentation for Models
 ...
 - [CbrainApi.Parameters](docs/Parameters.md)
 - [CbrainApi.Params](docs/Params.md)
 - [CbrainApi.Params1](docs/Params1.md)
